        ...
        <div className="header__inner">
          <div className="header__inner-row">
            <aside className="header__logo">
              <a href="/" className="logo ps-md-1 ps-lg-0 menu_justcall_logo relative">
                <img src="https://724voip.net/logo4.png" alt="JustCall Logo" style={{height:"80px"}}  loading="eager" className="pointer-events-none" />
              </a>
            </aside>
            <div className="ml-auto mr-[20px] md:hidden">
              <a href="/demo?internal-redirect=demo-mobile" className="btn btn-blue book-demo-nav opacity-0 start_free_trial_mobile_fixed">Book a Demo</a>
            </div>
              ...
              <nav className="header__menu-nav">
                <ul className="top__nav justify-stretch">
                      ...
                      <li className="sub-menu-sm__col !w-full">
                        <div className="lg:w-full">
                          <div className="sub-menu__banner d-none">
                            <a href="migration/" className="new_menu_migratetojustcal w-full !text-[#000]">
                          ...
                          <div className="lg:flex">
                            <ul className="sub-menu__links-col">
                              <li className="header__sub-menu-item">
                                <a href="migration/aircall-to-justcall/" className="new_menu_aircalltojustcall" />
                              ...
                              <li className="header__sub-menu-item">
                                <a href="migration/kixie-to-justcall/" className="new_menu_kixietojustcall" />
                                <div className="sub-menu-text">
                              ...
                              <li className="header__sub-menu-item">
                                <a href="migration/ringcentral-to-justcall/" className="new_menu_ringcentraltojustcall" />
                                <div className="sub-menu-text">
                            ...
                            <ul className="sub-menu__links-col">
                              <li className="header__sub-menu-item">
                                <a href="migration/phoneburner-to-justcall/" className="new_menu_phoneburnertojustcall" />
                                <div className="sub-menu-text">
                              ...
                              <li className="header__sub-menu-item">
                                <a href="migration/dialpad-to-justcall/" className="new_menu_dialpadtojustcall" />
                                <div className="sub-menu-text">
                              ...
                              <li className="header__sub-menu-item">
                                <a href="migration/orum-to-justcall/" className="new_menu_orumtojustcall" />
                                <div className="sub-menu-text">
                            ...
                            <ul className="sub-menu__links-col">
                              <li className="header__sub-menu-item">
                                <a href="migration/nooks-to-justcall/" className="new_menu_nookstojustcall" />
                                <div className="sub-menu-text">
                              ...
                              <li className="header__sub-menu-item">
                                <a href="migration/cloudtalk-to-justcall/" className="new_menu_cloudtalktojustcall" />
                                <div className="sub-menu-text">
                              ...
                              <li className="header__sub-menu-item">
                                <a href="migration/openphone-to-justcall/" className="new_menu_openphonetojustcall" />
                                <div className="sub-menu-text">
                      ...
                      <div className="lg:flex">
                        <div className="lg:w-[27%] bg-[#F8FAFF] lg:py-[35px] px-[10px] lg:px-[15px] rounded-[10px] lg:rounded-bl-[10px] mt-[10px] lg:mt-0">
                          <ul className="!py-[10px] lg:!py-0 sm:grid sm:grid-cols-2 lg:grid-cols-1">
                            <li className="header__sub-menu-item">
                              <a href="partner-program/solutions/" className="new_menu_solutionpartners" />
                            ...
                            <li className="header__sub-menu-item">
                              <a href="partner-program/tech/" className="new_menu_technologypartners" />
                            ...
                            <li className="header__sub-menu-item">
                              <a href="affiliates/" className="new_menu_affiliatepartners" />
                            ...
                            <li className="header__sub-menu-item">
                              <a href="/solution-partners" className="new_menu_hire" />
                        ...
                        <div className="lg:w-[72%] py-0 lg:pt-[35px] lg:pb-[25px] lg:ml-auto">
                          <li className="sub-menu-sm__col !w-full lg:!w-[65%]">
                            <ul className="!pt-[10px] lg:!pt-0">
                              <div className="sub-menu-sm__col_inner-container">
                                <ul>
                                  <li className="header__sub-menu-item">
                                    <a href="https://justcall.io/webinar/" className="new_menu_webinars" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="ai-agent-directory/" className="new_menu_ai_agent_directory" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="free-tools/" className="new_menu_free_business_tools" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="resource-hub/guides/" className="new_menu_guides" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="blog/" className="new_menu_blog" />
                                ...
                                <ul>
                                  <li className="header__sub-menu-item">
                                    <a href="just-talk/" className="new_menu_justtalk" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="customer-stories/" className="new_menu_customerstories" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="customers-wall-of-love/" className="new_menu_walloflove" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="/referral-program/" className="new_menu_referralprogram" />
                                  ...
                                  <li className="header__sub-menu-item">
                                    <a href="https://help.justcall.io/en/" className="new_menu_helpcenter" />
                          ...
                          <li className="sub-menu-sm__col hidden lg:block !w-[32%]">
                            <ul className="sub-menu__links-col last-col">
                              ...
                              <a href="partner-program/solutions/" className="btn btn-arrow btn-sm menu-feature-business-podcast">Learn More</a>
                            </ul>
                          </li>
                          <li className="see-all-features see-resources !w-full lg:!w-[63%]">
                            <a href="resource-hub" className="new_menu_allresources">View
                  ...
                  <li className="header__menu-item" id="customers-menu">
                    <a href="pricing/" className="new_menu_pricing menu_direct_link">Pricing</a>
                  </li>
          ...
          <ul class="sub-menu-sm single-col">
              <li class="sub-menu-sm__col !w-full">
                  ...
                  <li className="header__menu-item" id="contact-menu">
                    <a href="contact-us/" className="new_menu_contact menu_direct_link">Contact</a>
                  </li>
                  <li className="header__menu-item call-gradient-btn-nav relative lg:mr-[10px] !ml-auto">
                    <a href="tel:+19516668896" target="_blank" className="call-gradient-btn btn btn-outline !flex sm:!hidden justify-center lg:justify-start new_menu_sales_agent hover:!bg-transparent">
                    ...
                    <span className="hover:!bg-transparent call-gradient-btn desktop-call-gradient-btn btn btn-outline !hidden sm:!flex justify-center lg:justify-start new_menu_sales_agent !cursor-text w-full lg:w-auto opacity-0">
                      <svg width={31} height={32} className="call-icon" viewBox="0 0 31 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.78" d="M16.3413 4.76099C16.3413 4.76099 19.0994 5.01172 22.6096 8.52197C26.1199 12.0322 26.3706 14.7903 26.3706 14.7903" stroke="#004ce6" strokeWidth="2.05145" strokeLinecap="round" />
                        <path opacity="0.78" d="M16.6011 9.19354C16.6011 9.19354 17.8421 9.54813 19.7037 11.4097C21.5653 13.2713 21.9199 14.5124 21.9199 14.5124" stroke="#004ce6" strokeWidth="2.05145" strokeLinecap="round" />
                        <path d="M11.3738 8.9184L12.1875 10.3763C12.9217 11.692 12.627 13.418 11.4705 14.5745C11.4705 14.5745 10.0677 15.9772 12.6111 18.5206C15.1544 21.0639 16.5572 19.6612 16.5572 19.6612C17.7137 18.5047 19.4397 18.2099 20.7554 18.9442L22.2133 19.7579C24.2 20.8666 24.4347 23.6528 22.6884 25.3991C21.639 26.4484 20.3536 27.2649 18.9326 27.3187C16.5404 27.4094 12.4779 26.804 8.40276 22.7289C4.32763 18.6538 3.72221 14.5913 3.8129 12.1991C3.86677 10.7781 4.68326 9.49266 5.73258 8.44334C7.47888 6.69706 10.265 6.93168 11.3738 8.9184Z" stroke="#004ce6" strokeWidth="2.05145" strokeLinecap="round" />
                  ...
                  <li className="header__menu-item menu-btn-new lg:!ml-[5px] menu-btn-start-free-trial">
                    <a href="signup/" className="btn btn-outline try_for_free_menu_cta ampl-signup signup-link" id="signup-cta-nav">Start Free Trial</a>
                  </li>
                  <li className="header__menu-item !hidden lg:!block lg:!ml-[5px] book-demo-nav opacity-0 menu-btn-new">
                    <a href="/demo/?internal-redirect=book-demo-menu" className="book_a_demo_menu_CTA ampl-demo demo-link btn btn-primary">Book a Demo</a>
                  </li>
                  <li className="header__menu-item relative menu-btn-new lg:!ml-[5px] mt-[10px] lg:mt-0 !hidden lg:!block">
                    <a href="/login" className="new_menu_login login-link header-login-new">
            ...
            <div className="sub-menu-lg__left">
              <ul>
                ...
                <li className="see-all-features dark-blue">
                  <a href="features/" className="new_menu_features">See all features <img src="https://cdn.justcall.io/assets-marketing/images/svg/sub-menu-arrow.svg" alt="Menu Icon" width={15} height={15} loading="lazy" className="!w-[15px] h-auto pointer-events-none" /></a>
                </li>
              </ul>
            </div>
            <div className="sub-menu-lg__right">
                ...
                <div className="sub-menu__links-row sub-menu__links-2col">
                  <div className="lg:w-2/3">
                    <div className="sub-menu__banner ">
                      <a href="product/ai-voice-agent/" className="new_menu_ai_voice_agent">
                        <div className="sub-menu__banner-inner pointer-events-none">
                          <div>
                            <p className="text-[20px] lg:text-[22px] leading-[1.2] font-calSans mb-[5px] tracking-wide flex items-center">
                    ...
                    <div className="lg:flex">
                      <ul className="sub-menu__links-col">
                        ...
                        <li className="header__sub-menu-item">
                          <a href="solution/support-contact-center/" className="new_menu_inbound" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="solution/business-phone-system/" className="new_menu_businessphone" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ivr-call-menu/" className="new_menu_multilevel" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/forward-to-phone/" className="new_menu_callforwarding" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/call-distribution/" className="new_menu_automatedcalldistribution" />
                      ...
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="product/sales-dialer/" className="new_menu_salesdialer" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="solution/outbound-call-center-software/" className="new_menu_outbound" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/record-phone-calls/" className="new_menu_callrecording" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/call-center-analytics/" className="new_menu_advancedanalytics" />
                  ...
                  <ul className="sub-menu__links-col last-col">
                    ...
                    <a href="webinar/justcall-weekly-demo/?internal-redirect=weekly-demo-nav-bar" className="menu-feature-weeklydemo">
                    ...
                    <a href="webinar/justcall-weekly-demo/?internal-redirect=weekly-demo-nav-bar" className="btn btn-arrow btn-sm menu-feature-weeklydemo">Learn More</a>
                  </ul>
                </div>
              </div>
              <div className="sub-menu-toggle menu-pink-banner" id="messaging-m">
                <div className="sub-menu__links-row sub-menu__links-2col">
                  <div className="lg:w-2/3">
                    <div className="sub-menu__banner ">
                      <a href="product/email/" className="new_menu_email">
                        <div className="sub-menu__banner-inner pointer-events-none">
                          <div>
                            <p className="text-[20px] lg:text-[22px] leading-[1.2] font-calSans mb-[5px] tracking-wide flex items-center">
                              JustCall Email</p>
                    ...
                    <div className="lg:flex">
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="product/send-and-receive-sms/" className="new_menu_smsmmsinbox" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/sms-workflows/" className="new_menu_smsworkflows" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/whatsapp-sms-messaging/" className="new_menu_whatsappinbox" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/sms-copilot/" className="new_menu_smscopilot" />
                      ...
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="solution/sms-campaign/" className="new_menu_smscampaigns" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/bulk-sms/" className="new_menu_bulksms" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/sms-bot/" className="new_menu_smsbot" />
                ...
                <div className="sub-menu__links-row sub-menu__links-2col">
                  <div className="lg:w-2/3">
                    ...
                    <div className="lg:flex">
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="product/outbound-ai-voice-agent/" className="new_menu_outbound_ai_voice_agent" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/answering-services/" className="new_menu_answering_service" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-voice-agent/ai-sdr/" className="new_menu_ai_sdr" />
                      ...
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="product/ai-receptionist/" className="new_menu_ai_receptionist" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/virtual-phone-answering/" className="new_menu_virtual_phone_answering" />
                ...
                <div className="sub-menu__links-row sub-menu__links-2col">
                  <div className="lg:w-2/3">
                    ...
                    <div className="lg:flex">
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="solution/conversation-intelligence/" className="new_menu_conversationintelligence" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-coaching/" className="new_menu_aicoaching" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-agent-assist/" className="new_menu_agentassist" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-call-scoring/" className="new_menu_callscoring" />
                      ...
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="product/ai-analytics/" className="new_menu_agentanalytics" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-call-transcription-summary/" className="new_menu_calltranscription" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/moment-analysis/" className="new_menu_momentanalysis" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-sentiment-analysis/" className="new_menu_sentimentanalysis" />
              ...
              <div className="sub-menu-toggle" id="automation-m">
                <div className="sub-menu__links-row sub-menu__links-2col">
                  <div className="lg:w-2/3">
                    <div className="sub-menu__banner ">
                      <a href="product/workflows/ " className="new_menu_workflow_main">
                        <div className="sub-menu__banner-inner pointer-events-none">
                          <div>
                            <p className="text-[20px] lg:text-[22px] leading-[1.2] font-calSans mb-[5px] tracking-wide flex items-center">
                    ...
                    <div className="lg:flex">
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="integration/" className="new_menu_integration" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/call-disposition/" className="new_menu_calldisposition" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/sms-bot/" className="new_menu_smsbots" />
                      ...
                      <ul className="sub-menu__links-col">
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/ai-call-scoring/" className="new_menu_automatedcallscoring" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/predictive-dialer/" className="new_menu_predictivedialer" />
              ...
              <div className="sub-menu-toggle" id="integrations">
                <div className="lg:flex h-full">
                    ...
                    <div className="sub-menu__links-row column">
                      <ul className="sub-menu-integrations">
                        <li className="integration-item">
                          <a href="integration/hubspot/" className="new_menu_hubspot">
                        ...
                        <li className="integration-item">
                          <a href="integration/salesforce/" className="new_menu_salesforce">
                        ...
                        <li className="integration-item">
                          <a href="integration/pipedrive/" className="new_menu_pipedrive">
                        ...
                        <li className="integration-item">
                          <a href="integration/active-campaign/" className="new_menu_activecampaign">
                        ...
                        <li className="integration-item">
                          <a href="integration/monday/" className="new_menu_monday">
                        ...
                        <li className="integration-item">
                          <a href="integration/zoho-crm/" className="new_menu_zohocrm">
                        ...
                        <li className="integration-item">
                          <a href="integration/zendesk/" className="new_menu_zendesk">
                        ...
                        <li className="integration-item">
                          <a href="integration/freshdesk/" className="new_menu_freshdesk">
                        ...
                        <li className="integration-item">
                          <a href="integration/copper/" className="new_menu_cooper">
                        ...
                        <li className="integration-item">
                          <a href="integration/zapier/" className="new_menu_zapier">
                        ...
                        <li className="integration-item">
                          <a href="integration/intercom/" className="new_menu_intercom">
                        ...
                        <li className="integration-item">
                          <a href="integration/slack/" className="new_menu_slack">
                        ...
                        <li className="integration-item">
                          <a href="integration/outreach/" className="new_menu_msteams">
                        ...
                        <li className="integration-item">
                          <a href="integration/apollo/" className="new_menu_apollo">
                        ...
                        <li className="integration-item">
                          <a href="integration/highlevel/" target="_blank" className="new_menu_api">
                  ...
                  <ul className="sub-menu__links-col last-col">
                    ...
                    <a href="product/api-and-webhooks/?internal-redirect=nav-api" target="_blank" className="btn btn-arrow btn-sm menu-feature-integration">Learn More</a>
                  </ul>
                </div>
              </div>
              <div className="sub-menu-toggle" id="platform">
                <div className="sub-menu__links-row sub-menu__links-2col">
                  <div className="lg:w-2/3">
                    <div className="sub-menu__banner ">
                      <a href="platform/" className="new_menu_platform_overview">
                        <div className="sub-menu__banner-inner pointer-events-none">
                          <div>
                    ...
                    <div className="lg:flex">
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="/" className="new_menu_connect" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="product/sales-dialer/" className="new_menu_prospect" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="platform/helpwise/" className="new_menu_assist" />
                      ...
                      <ul className="sub-menu__links-col">
                        <li className="header__sub-menu-item">
                          <a href="platform/callpage/" className="new_menu_convert" />
                        ...
                        <li className="header__sub-menu-item">
                          <a href="ai/" className="new_menu_coach" />
            ...
            <div className="sub-menu-lg__right">
              <div className="sub-menu-toggle" id="team-menu">
                <div className="sub-menu__links-row">
                  <ul className="sub-menu__links-col">
                    <li className="header__sub-menu-item">
                      <a href="teams/sales/" className="new_menu_sales" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="teams/lead-gen-agency/" className="new_menu_leadgen" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="teams/marketing/" className="new_menu_marketing" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="teams/it-operations/" className="new_menu_it_operations" />
                  ...
                  <ul className="sub-menu__links-col">
                    <li className="header__sub-menu-item">
                      <a href="teams/customer-success/" className="new_menu_customer_success" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="teams/customer-support/" className="new_menu_customer_support" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="teams/recruitment/" className="new_menu_recruitment" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="teams/dispatch/" className="new_menu_dispatch" />
                ...
                <div className="integrations-more teams-more">
                  <a href="teams/" className="new_menu_teams">
              ...
              <div className="sub-menu-toggle" id="industry-menu">
                <div className="sub-menu__links-row">
                  <ul className="sub-menu__links-col">
                    <li className="header__sub-menu-item">
                      <a href="industry/dental-services/" className="new_menu_dental_services" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="industry/healthcare/" className="new_menu_healthcare" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="industry/education/" className="new_menu_education" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="industry/fitness-wellness/" className="new_menu_fitness" />
                  ...
                  <ul className="sub-menu__links-col">
                    <li className="header__sub-menu-item">
                      <a href="industry/solar/" className="new_menu_solar" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="industry/real-estate/" className="new_menu_realestate" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="industry/financial-services/" className="new_menu_finance" />
                    ...
                    <li className="header__sub-menu-item">
                      <a href="industry/retail/" className="new_menu_retail" />
                ...
                <div className="integrations-more teams-more">
                  <a href="industry/" className="new_menu_industry">
...
const Test = () => {
  return (
    <header className="border-b border-border/60 z-50 h-16 flex items-center"><div className="container-fixed flex items-center justify-between"><div className="flex items-center justify-start gap-2.5"><a className="flex items-center gap-2 leading-0" href="/metronic"><img alt="Metronic" loading="lazy" width={135} height={0} decoding="async" data-nimg={1} className="shrink-0 dark:hidden" style={{color: 'transparent'}} src="/metronic/logo/default-light.svg" /><img alt="Metronic" loading="lazy" width={135} height={0} decoding="async" data-nimg={1} className="shrink-0 hidden dark:block" style={{color: 'transparent'}} src="/metronic/logo/default-dark.svg" /></a></div><nav className="hidden lg:flex items-center justify-center"><div className="flex items-center relative"><a data-nav-item="Tailwind" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground" href="/metronic"><span className="flex items-center space-x-1">Tailwind</span></a><a data-nav-item="Bootstrap" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground/80" href="/metronic/bootstrap"><span className="flex items-center space-x-1">Bootstrap</span></a><a data-nav-item="Docs" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground/80" href="/metronic/docs"><span className="flex items-center space-x-1">Docs</span></a><a data-nav-item="Pricing" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground/80" href="/metronic/pricing"><span className="flex items-center space-x-1">Pricing</span></a><a data-nav-item="Changelog" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground/80" href="/metronic/changelog"><span className="flex items-center space-x-1">Changelog</span></a><a href="https://devs.keenthemes.com" target="_blank" rel="noopener noreferrer" data-nav-item="Support" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground/80"><span className="flex items-center space-x-1">Support</span></a><a href="https://keenthemes.studio" target="_blank" rel="noopener noreferrer" data-nav-item="Hire Us" className="relative px-4 py-2 text-sm font-medium transition-colors z-10 rounded-full whitespace-nowrap text-foreground/80"><span className="flex items-center space-x-1">Hire Us</span></a><nav aria-label="Main" data-orientation="horizontal" dir="ltr" data-slot="navigation-menu" data-viewport="true" className="group/navigation-menu relative flex max-w-max flex-1 items-center justify-center"><div style={{position: 'relative'}}><ul data-orientation="horizontal" data-slot="navigation-menu-list" className="group flex flex-1 list-none items-center justify-center gap-1" dir="ltr"><li data-slot="navigation-menu-item" className="relative"><button id="radix-_R_8ciav5tdb_-trigger-radix-_R_1ociav5tdb_" data-state="closed" aria-expanded="false" aria-controls="radix-_R_8ciav5tdb_-content-radix-_R_1ociav5tdb_" data-slot="navigation-menu-trigger" className="cursor-pointer group inline-flex h-9 w-max items-center justify-center bg-background hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-accent/50 data-[state=open]:bg-accent/50 data-[active=true]:text-accent-foreground ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 focus-visible:ring-4 focus-visible:outline-1 group relative px-4 py-2 text-sm font-medium transition-colors z-10 bg-transparent! rounded-full whitespace-nowrap text-foreground/80" data-nav-item="More" data-radix-collection-item><span className="relative z-20">More</span> <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-chevron-down relative top-[1px] ms-1 size-3.5 opacity-60 transition duration-300 group-data-[state=open]:rotate-180" aria-hidden="true"><path d="m6 9 6 6 6-6" /></svg></button></li></ul></div><div className="absolute top-full left-0 isolate z-50 flex justify-center" /></nav><div className="absolute top-0 h-full backdrop-blur-sm rounded-full border border-input bg-muted/80 z-[5] pointer-events-none" style={{willChange: 'transform, width', transform: 'none', width: '87.3438px'}} /></div></nav><div className="flex items-center justify-end gap-5"><div className="flex items-center gap-1.5"><button data-slot="button" className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:hover:bg-accent/50 size-9 bg-transparent hover:bg-transparent text-foreground hover:text-foreground"><a target="_blank" href="https://github.com/keenthemes"><svg viewBox="0 0 438.549 438.549" className="opacity-100"><path fill="currentColor" d="M409.132 114.573c-19.608-33.596-46.205-60.194-79.798-79.8-33.598-19.607-70.277-29.408-110.063-29.408-39.781 0-76.472 9.804-110.063 29.408-33.596 19.605-60.192 46.204-79.8 79.8C9.803 148.168 0 184.854 0 224.63c0 47.78 13.94 90.745 41.827 128.906 27.884 38.164 63.906 64.572 108.063 79.227 5.14.954 8.945.283 11.419-1.996 2.475-2.282 3.711-5.14 3.711-8.562 0-.571-.049-5.708-.144-15.417a2549.81 2549.81 0 01-.144-25.406l-6.567 1.136c-4.187.767-9.469 1.092-15.846 1-6.374-.089-12.991-.757-19.842-1.999-6.854-1.231-13.229-4.086-19.13-8.559-5.898-4.473-10.085-10.328-12.56-17.556l-2.855-6.57c-1.903-4.374-4.899-9.233-8.992-14.559-4.093-5.331-8.232-8.945-12.419-10.848l-1.999-1.431c-1.332-.951-2.568-2.098-3.711-3.429-1.142-1.331-1.997-2.663-2.568-3.997-.572-1.335-.098-2.43 1.427-3.289 1.525-.859 4.281-1.276 8.28-1.276l5.708.853c3.807.763 8.516 3.042 14.133 6.851 5.614 3.806 10.229 8.754 13.846 14.842 4.38 7.806 9.657 13.754 15.846 17.847 6.184 4.093 12.419 6.136 18.699 6.136 6.28 0 11.704-.476 16.274-1.423 4.565-.952 8.848-2.383 12.847-4.285 1.713-12.758 6.377-22.559 13.988-29.41-10.848-1.14-20.601-2.857-29.264-5.14-8.658-2.286-17.605-5.996-26.835-11.14-9.235-5.137-16.896-11.516-22.985-19.126-6.09-7.614-11.088-17.61-14.987-29.979-3.901-12.374-5.852-26.648-5.852-42.826 0-23.035 7.52-42.637 22.557-58.817-7.044-17.318-6.379-36.732 1.997-58.24 5.52-1.715 13.706-.428 24.554 3.853 10.85 4.283 18.794 7.952 23.84 10.994 5.046 3.041 9.089 5.618 12.135 7.708 17.705-4.947 35.976-7.421 54.818-7.421s37.117 2.474 54.823 7.421l10.849-6.849c7.419-4.57 16.18-8.758 26.262-12.565 10.088-3.805 17.802-4.853 23.134-3.138 8.562 21.509 9.325 40.922 2.279 58.24 15.036 16.18 22.559 35.787 22.559 58.817 0 16.178-1.958 30.497-5.853 42.966-3.9 12.471-8.941 22.457-15.125 29.979-6.191 7.521-13.901 13.85-23.131 18.986-9.232 5.14-18.182 8.85-26.84 11.136-8.662 2.286-18.415 4.004-29.263 5.146 9.894 8.562 14.842 22.077 14.842 40.539v60.237c0 3.422 1.19 6.279 3.572 8.562 2.379 2.279 6.136 2.95 11.276 1.995 44.163-14.653 80.185-41.062 108.068-79.226 27.88-38.161 41.825-81.126 41.825-128.906-.01-39.771-9.818-76.454-29.414-110.049z" /></svg></a></button><button data-slot="button" className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:hover:bg-accent/50 size-9 bg-transparent hover:bg-transparent text-foreground hover:text-foreground"><a target="_blank" href="https://x.com/keenthemes"><svg className="size-3.5 opacity-100" viewBox="0 0 1200 1227"><path fill="currentcolor" d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" /></svg></a></button></div><button data-slot="hover-card-trigger" className="cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive from-primary to-primary/85 text-primary-foreground border border-zinc-950/25 bg-gradient-to-t shadow-md shadow-zinc-950/20 ring-1 ring-inset ring-white/20 transition-[filter] duration-200 hover:brightness-110 active:brightness-90 dark:border-white/20 dark:ring-transparent h-9 rounded-lg px-4 py-2 has-[>svg]:px-3 relative group" data-state="closed">Buy Now</button></div></div></header>
